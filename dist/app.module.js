...
const checkmessage_module_1 = require("./checktext/checkmessage.module");
const flashcard_module_1 = require("./flashcards/flashcard.module");
const message_module_1 = require("./message/message.module");
const conversation_module_1 = require("./conversation/conversation.module");
const mongodatabase_module_1 = require("./database/mongodatabase.module");
...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            checkmessage_module_1.CheckMessageModule,
            flashcard_module_1.FlashcardModule,
            message_module_1.MessageModule,
            conversation_module_1.ConversationModule,
            mongodatabase_module_1.MongodatabaseModule,
